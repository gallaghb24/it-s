# Intelligent Transformation Studio Website

A modern, minimalist one-page website for Intelligent Transformation Studio - designed for senior operations, marketing and transformation leaders.
...
If you want to use a custom domain like `intelligenttransformation.studio`:
...
### Colors
- **Coral Accent**: #FF6B6B
- **Slate Grey**: #475569 (primary text and dark sections)
...
:root {
    ...
    --slate: #475569;        /* Primary grey for text/sections */
...
This website template is provided as-is for Intelligent Transformation Studio.

---

**Tagline for SEO/Social**: 
Intelligent Transformation Studio – Transforming how work gets done through operational design, automation and AI.
